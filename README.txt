...
- Upcoming events on the client page Events should already show up in the table, but the table doesn't have the right columns; among other things, start and end date should be replaced by date and start/end time and total time. I have design pictures but they basically mirror the specs you gave
